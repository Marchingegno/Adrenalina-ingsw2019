...
public class GameMapTest {
	...
	public void getNumOfRows_correctInput_correcntOutput(){
		GameBoard gameBoard = new GameBoard( players, 8);
		GameMap map = new GameMap("MediumMap.txt", gameBoard.getPlayers(), gameBoard);
		gameBoard.setGameMap(map);
	...
	public void reachableCoordinates_maxDistance1_correctOutput() {
		GameBoard gameBoard = new GameBoard( players, 8);
		GameMap map = new GameMap("BigMap.txt", gameBoard.getPlayers(), gameBoard);
		gameBoard.setGameMap(map);
		ArrayList<Coordinates> correctOutput = new ArrayList<>();
	...
	public void reachableCoordinates_maxDistance3_correctOutput() {
		GameBoard gameBoard = new GameBoard( players, 8);
		GameMap map = new GameMap("SmallMap.txt", gameBoard.getPlayers(), gameBoard);
		gameBoard.setGameMap(map);
		ArrayList<Coordinates> correctOutput = new ArrayList<>();
		correctOutput.add(new Coordinates(2,2));
		correctOutput.add(new Coordinates(2,1));
	...
	public void getRoomCoordinates_SmallMapBlackSquare_throwsOutOfBoundaryException() {
		...
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, -1, possibleDirection, new Coordinates(0,2), gameBoard));
	}
	...
	public void getRoomCoordinates_SmallMapSquareOutOfTheMap1_throwsOutOfBoundaryException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, 4, possibleDirection, new Coordinates(0,9), gameBoard));
	}
	...
	public void getRoomCoordinates_SmallMapSquareOutOfTheMap2_throwsOutOfBoundaryException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, -1, possibleDirection, new Coordinates(0,0), gameBoard));
	}
	...
	public void getRoomCoordinates_SmallMapSquareOutOfTheMap3_throwsOutOfBoundaryException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, 4, possibleDirection, new Coordinates(0,0), gameBoard));
	}
	...
	public void getRoomCoordinates_SmallMapSquareOutOfTheMap4_throwsOutOfBoundaryException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, -1, possibleDirection, new Coordinates(9,9), gameBoard));
	}
	...
	public void getRoomCoordinates_SmallMapSquareOutOfTheMap_throwsOutOfBoundaryException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, 4, possibleDirection, new Coordinates(9,1), gameBoard));
	}
	...
	public void getRoomCoordinates_SmallMapNewSquare_throwsOutOfBoundaryException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getRoomCoordinates(new SpawnSquare(AmmoType.RED_AMMO, 2, possibleDirection, new Coordinates(0, 1), gameBoard));
	}
	...
	public void getCoordinates_squareNotInTheMap_throwsOutOfBoundariesException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getCoordinates(new SpawnSquare(AmmoType.RED_AMMO, 4, possibleDirection, new Coordinates(2,1), gameBoard));
	}
	...
	public void getCoordinates_squareOutOfBoundaries_throwsOutOfBoundariesException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getCoordinates(new SpawnSquare(AmmoType.RED_AMMO, 4, possibleDirection, new Coordinates(5,1), gameBoard));
	}
	...
	public void getCoordinates_blackSquare_throwsOutOfBoundariesException() {
		...
		possibleDirection[2] = true;
		possibleDirection[3] = true;
		map.getCoordinates(new SpawnSquare(AmmoType.RED_AMMO, -1, possibleDirection, new Coordinates(2,1), gameBoard));
	}
